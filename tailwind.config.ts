  ...
  theme: {
    extend: {
      colors: {
        ...
        // ── Radix UI + Tailwind color palettes (from tailwind.config.js) ───
        slate: {
      ...
      // ── Border Radius (absolute px — matched to tailwind.config.js) ─────
      borderRadius: {
        xs:    '2px',
        sm:    '4px',
        md:    '6px',
      ...
      // ── Font Weight (matched to tailwind.config.js) ───────────────────────
      fontWeight: {
        thin:       '100',
        extralight: '200',
        light:      '300',
      ...
      // ── Line Height (matched to tailwind.config.js, px-based) ────────────
      lineHeight: {
        '3':  '12px',
        '4':  '16px',
        '5':  '20px',
      ...
      // ── Letter Spacing (matched to tailwind.config.js) ───────────────────
      letterSpacing: {
        tighter: '-0.05em',
        tight:   '-0.025em',
        normal:  '0em',
      ...
      // ── Spacing (Figma-aligned semantic names) ───────────────────────────
      spacing: {
        ...
        xl:    '2rem',    // 32px
        '2xl': '2.5rem',  // 40px — Figma spacing.2xl
        '3xl': '3.5rem',  // 56px — Figma spacing.3xl
      },
